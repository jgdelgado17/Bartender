...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> manejarTodasExcepciones(Exception e) {
        ...
        ExceptionResponse exceptionResponse = new ExceptionResponse("Ocurrió un error");
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        ExceptionResponse exceptionResponse = new ExceptionResponse("Ocurrió un error",  errors);
